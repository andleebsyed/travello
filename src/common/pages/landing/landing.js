    ...
    return (
        ...
        <section className="w-full flexbreak:w-auto flex justify-center">
            ...
            <section className="flex flex-col w-full flexbreak:w-auto justify-between p-9">
                <div>
                    <h1 className="text-white font-extrabold text-2xl sm:text-5xl mb-12 max-w-lg">Make your adventures memorable</h1>
                ...
                <div className="w-full xsm:flex">
                    ...
                    <button className="border border-blue-light rounded-2xl p-4 text-blue-light font-bold mt-4 xsm:mt-0 w-full xsm:w-60">Log in</button>
                </div>
